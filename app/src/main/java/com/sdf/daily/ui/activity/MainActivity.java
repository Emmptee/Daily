...
import com.sdf.daily.constant.HeadConstant;
import com.sdf.daily.constant.RxBusCode;
import com.sdf.daily.model.RxEventHeadBean;
import com.sdf.daily.ui.fragment.home.child.HomeFragment;
import com.sdf.daily.ui.fragment.home.HomeRootFragment;
...
import com.sdf.sdk.utils.NavigationUtils;
import com.sdf.sdk.utils.SpUtils;
import com.sdf.sdk.utils.ToastUtils;
import com.sdf.sdk.widgets.MovingViewAnimator;
...
public class MainActivity extends BaseCompatActivity implements HomeFragment.OnOpenDrawerLayoutListener{
    ...
    protected void initView(Bundle savedInstanceState) {
        if (savedInstanceState == null) {
            ...
            mFragments[FOURTH] = findFragment(HomeRootFragment.class);
            mFragments[FIFTH] = findFragment(HomeRootFragment.class);
        }
